...
window.SOCIAL_POSTS_CONFIG = [
    ...
    },
    {
        ...
        likes: 1650,
        comments: 98,
        timestamp: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000), // hace 10 días
        url: "https://instagram.com"
    }
];
...
window.CAROUSEL_CONFIG = {
    ...
    autoplayDelay: 5000,              // Milisegundos entre slides (5000 = 5 segundos)
    pauseOnMouseEnter: true,          // Pausar al pasar el mouse
    loop: true,                        // Repetir carrusel infinitamente
    grabCursor: true,                 // Cambiar cursor al pasar sobre slides
    centeredSlides: false,            // Centrar slides activos

    // Animación
    speed: 600,                       // Tiempo de transición en ms
    effect: "slide",                  // Tipo de efecto: 'slide', 'fade', 'cube', 'coverflow'

    // Responsive - cantidad de slides visibles
    slidesPerView: {
        mobile: 1.1,                  // < 640px
        tablet: 2.1,                  // 640px - 1024px
        desktop: 3                    // > 1024px
    },
    ...
    pagination: {
        enabled: true,
        dynamicBullets: true,         // Los puntos se ajustan dinámicamente
...
window.SOCIAL_APIS_CONFIG = {
    ...
    instagram: {
        enabled: false,                // Cambiar a true para usar API
        token: "TU_INSTAGRAM_TOKEN",  // Reemplaza con tu token
    ...
    facebook: {
        enabled: false,                // Cambiar a true para usar API
        token: "TU_FACEBOOK_TOKEN",   // Reemplaza con tu token
...
window.CACHE_CONFIG = {
    enabled: true,                    // Usar localStorage para caché
    key: "social_posts_cache",        // Clave de caché
...
window.APPEARANCE_CONFIG = {
    ...
    primaryColor: "#005daa",          // Azul principal
    accentColor: "#c49e4f",           // Color dorado
    instagramGradient: "from-pink-400 to-purple-500",  // Gradiente de Instagram
    facebookGradient: "from-blue-500 to-blue-700",     // Gradiente de Facebook

    // Animaciones
    animationDuration: 600,           // Duración de animaciones en ms
    hoverScale: 1.02,                 // Escala al hacer hover
    hoverElevation: true,             // Efecto de elevación

    // Mostrar/ocultar elementos
    showAvatar: true,                 // Mostrar avatar del autor
    showTimestamp: true,              // Mostrar fecha/hora
    showStats: true,                  // Mostrar likes y comentarios
    showViewMore: true,               // Mostrar botón "Ver más"
...
window.updatePosts = function(newPosts) {
    ...
    if (window.SocialCarouselManager) {
        const carousel = new window.SocialCarouselManager();
...
window.getPostsByPlatform = function(platform) {
    return window.SOCIAL_POSTS_CONFIG.filter(post => post.platform === platform);
};
...
window.getSocialStats = function() {
    ...
    window.SOCIAL_POSTS_CONFIG.forEach(post => {
